...
function renderUsersGryffindor() {
  let users = characterArray;
  let html = "";
  users.forEach((user) => {
    if (
...
function renderUsersHufflepuff() {
  let users = characterArray;
  let html = "";
  users.forEach((user) => {
    if (
